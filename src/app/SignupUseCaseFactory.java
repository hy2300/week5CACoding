...
public class SignupUseCaseFactory {
    ...
    public static SignupView create(
        ...
        try {
            ...
            ClearController clearController = createClearUserCase(clearViewModel, clearuserDataAccessObject);
    ...
    private static ClearController createClearUserCase(ClearViewModel clearViewModel, ClearUserDataAccessInterface userDataAccessObject) throws IOException{

        ClearOutputBoundary clearOutputBoundary = new ClearPresenter(clearViewModel);

        ClearInputBoundary clearInteractor = new ClearInteractor(clearOutputBoundary, userDataAccessObject);
